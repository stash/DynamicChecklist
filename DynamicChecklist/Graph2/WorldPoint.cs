namespace DynamicChecklist.Graph2
{
    ...
    /// <summary>
    /// A point in tile-space X,Y coordinates belonging to some <see cref="GameLocation"/>.
    /// </summary>
    public class WorldPoint : IEquatable<WorldPoint>
    {
        ...
        public WorldPoint(GameLocation location, int x, int y)
        {
        ...
        public WorldPoint(GameLocation location, Microsoft.Xna.Framework.Vector2 screenCoord)
        ...
        public WorldPoint(GameLocation location, Microsoft.Xna.Framework.Point screenPoint)
        ...
        public WorldPoint(GameLocation location, xTile.Dimensions.Location tilePoint)
        ...
        /// <summary>Gets the <see cref="GameLocation"/> that this point belongs to.</summary>
        ...
        /// <returns>A <see cref="WorldPoint"/> in the same <see cref="GameLocation"/> at new coordinates</returns>
        ...
        public bool Equals(WorldPoint other)
        {
            return (other is object) &&
                   EqualityComparer<GameLocation>.Default.Equals(this.Location, other.Location) &&
                   this.X == other.X &&
                   this.Y == other.Y;
        }
        ...
        public override int GetHashCode()
        {
            ...
            hashCode = hashCode * -1521134295 + EqualityComparer<GameLocation>.Default.GetHashCode(this.Location);
            hashCode = hashCode * -1521134295 + this.X.GetHashCode();
            hashCode = hashCode * -1521134295 + this.Y.GetHashCode();
            return hashCode;
        }

        public override string ToString() => $"{this.X},{this.Y}@{this.Location.NameOrUniqueName}";

        public string ToShortString() => $"{this.X},{this.Y}@{this.Location.Name}";
